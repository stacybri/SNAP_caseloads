...
bysort st_fips: carryforward tot_snap_policy, replace
bysort st_fips: carryforward tot_snap_policy_eligibility, replace
bysort st_fips: carryforward tot_snap_policy_transaction, replace
...
su `try1a'_fra_exp_w  `try1a'_tot_pred_w_chg `try1a'_fra_exp_fsp_all `try1a'_tot_pred_fsp_all_chg  `try1a'_fra_exp_fsp_tc `try1a'_tot_pred_fsp_tc_chg  `try1a'_fra_exp_fsp_elig `try1a'_tot_pred_fsp_elig_chg  `try1a'_fra_exp_fsp_eligb `try1a'_tot_pred_fsp_eligb_chg `try1a'_fra_exp_fsp_abawd `try1a'_tot_pred_fsp_abawd_chg  `try1a'_fra_exp_fsp_noncit `try1a'_tot_pred_fsp_noncit_chg  `try1a'_fra_exp_wel_o `try1a'_tot_pred_wel_o_chg  `try1a'_fra_exp_veitc `try1a'_tot_pred_veitc_chg  `try1a'_fra_exp_es `try1a'_tot_pred_es_chg `try1a'_fra_exp_o `try1a'_tot_pred_o_chg  `try1a'_total_chg, detail

su `try1a'_fra_exp_w `try1a'_tot_pred_w_chg `try1a'_fra_exp_fsp_all `try1a'_tot_pred_fsp_all_chg  `try1a'_fra_exp_fsp_tc `try1a'_tot_pred_fsp_tc_chg  `try1a'_fra_exp_fsp_elig `try1a'_tot_pred_fsp_elig_chg  `try1a'_fra_exp_fsp_eligb `try1a'_tot_pred_fsp_eligb_chg `try1a'_tot_pred_fsp_abawd_chg `try1a'_fra_exp_fsp_noncit `try1a'_tot_pred_fsp_noncit_chg  `try1a'_fra_exp_wel_o `try1a'_tot_pred_wel_o_chg  `try1a'_fra_exp_veitc `try1a'_tot_pred_veitc_chg  `try1a'_fra_exp_es `try1a'_tot_pred_es_chg `try1a'_fra_exp_o `try1a'_tot_pred_o_chg  `try1a'_total_chg  if yrmo>=`begin_yrmo' & yrmo<=`end_yrmo'
bysort st_fips: su `try1a'_fra_exp_w  `try1a'_tot_pred_w_chg  `try1a'_fra_exp_fsp_all `try1a'_tot_pred_fsp_all_chg  `try1a'_fra_exp_fsp_tc `try1a'_tot_pred_fsp_tc_chg  `try1a'_fra_exp_fsp_elig `try1a'_tot_pred_fsp_elig_chg  `try1a'_fra_exp_fsp_eligb `try1a'_fra_exp_fsp_abawd `try1a'_tot_pred_fsp_eligb_chg  `try1a'_fra_exp_fsp_noncit `try1a'_tot_pred_fsp_noncit_chg  `try1a'_fra_exp_wel_o `try1a'_tot_pred_wel_o_chg  `try1a'_fra_exp_veitc `try1a'_tot_pred_veitc_chg  `try1a'_fra_exp_es `try1a'_tot_pred_es_chg `try1a'_fra_exp_o `try1a'_tot_pred_o_chg `try1a'_total_chg  if yrmo>=`begin_yrmo' & yrmo<=`end_yrmo'
...
save ${tdate}_results_${base_mo}_${base_yr}_${end_mo}_${end_yr}/`try1a'_24lags_results_fsp/`try1a'_24lags_estimates_fsp_`var', replace
}
...
append using "${tdate}_results_${base_mo}_${base_yr}_${end_mo}_${end_yr}/`try1a'_24lags_results_fsp/`try1a'_24lags_estimates_fsp_overall.dta"
		foreach var in top_states bottom_states top_states_transaction bottom_states_transaction top_states_eligibility bottom_states_eligibility {
			append using "${tdate}_results_${base_mo}_${base_yr}_${end_mo}_${end_yr}/`try1a'_24lags_results_fsp/`try1a'_24lags_estimates_fsp_`var'.dta"
			}
save ${tdate}_results_${base_mo}_${base_yr}_${end_mo}_${end_yr}/`try1a'_24lags_results_fsp/`try1a'_24lags_estimates_fsp, replace
...
foreach set in iebt cert0103_ care cres res tran bio apply ads outreachdoll unemp dmeff {
local set1=substr("`set'",1,5)
...
collapse (firstnm) state_pc (mean) `try1a'_fra_exp_w `try1a'_fra_exp_w2  `try1a'_tot_pred_w_chg `try1a'_fra_exp_fsp_all* `try1a'_tot_pred_fsp_all_chg  `try1a'_fra_exp_fsp_tc* `try1a'_tot_pred_fsp_tc_chg  `try1a'_fra_exp_fsp_elig `try1a'_fra_exp_fsp_elig2 `try1a'_tot_pred_fsp_elig_chg  `try1a'_fra_exp_fsp_eligb* `try1a'_tot_pred_fsp_eligb_chg `try1a'_fra_exp_fsp_abawd* `try1a'_tot_pred_fsp_abawd_chg  `try1a'_fra_exp_fsp_noncit* `try1a'_tot_pred_fsp_noncit_chg $addition_var  `try1a'_fra_exp_wel_o* `try1a'_tot_pred_wel_o_chg  `try1a'_fra_exp_veitc* `try1a'_tot_pred_veitc_chg   `try1a'_fra_exp_es* `try1a'_tot_pred_es_chg `try1a'_fra_exp_o* `try1a'_tot_pred_o_chg `try1a'_total_chg beg_year beg_mo end_year end_mo $unemp24 $welf24 $teitc24 $temp24 dkatrina pop top_states bottom_states top_states_transaction bottom_states_transaction top_states_eligibility bottom_states_eligibility (firstnm) snap_tot yrmo if yrmo>=`begin_yrmo' & yrmo<=`end_yrmo'  , by(st_fips)
...
save ${tdate}_results_${base_mo}_${base_yr}_${end_mo}_${end_yr}/`try1a'_24lags_results_fsp/`try1a'_24lags_se_fsp_rep`rep'_`var', replace
}
...
append using "${tdate}_results_${base_mo}_${base_yr}_${end_mo}_${end_yr}/`try1a'_24lags_results_fsp/`try1a'_24lags_se_fsp_overall`rep'.dta"
		foreach var in top_states bottom_states top_states_transaction bottom_states_transaction top_states_eligibility bottom_states_eligibility {
			append using "${tdate}_results_${base_mo}_${base_yr}_${end_mo}_${end_yr}/`try1a'_24lags_results_fsp/`try1a'_24lags_se_fsp_rep`rep'_`var'.dta"
			}
save ${tdate}_results_${base_mo}_${base_yr}_${end_mo}_${end_yr}/`try1a'_24lags_results_fsp/`try1a'_24lags_se_fsp_rep`rep', replace
...
label define over -100 "Artificial USA Low" -10 "Artificial USA" 0 "USA Overall" -1 "Top 10% Overall FSP" -2 "Bottom 10% Overall FSP" -3 "Top 10% Transaction Policies" -4 "Bottom 10% Transaction Policies" -5 "Top 10% Eligibility Policies" -6 "Bottom 10% Eligibility Policies" 
label values st_fips over

 
 foreach z in top_states bottom_states top_states_transaction bottom_states_transaction top_states_eligibility bottom_states_eligibility {
 replace state_pc="${`z'}" if state_pc=="`z'"
 }
...
sort st_fips se
order se
save ${tdate}_results_${base_mo}_${base_yr}_${end_mo}_${end_yr}/`try1a'_24lags_results_fsp/`try1a'_24lags_fsp, replace
append using ${tdate}_results_${base_mo}_${base_yr}_${end_mo}_${end_yr}/`try1a'_24lags_results_fsp/`try1a'_24lags_fsp_artificial_usa
append using ${tdate}_results_${base_mo}_${base_yr}_${end_mo}_${end_yr}/`try1a'_24lags_results_fsp/`try1a'_24lags_fsp_artificial_low_usa


sort st_fips se

export excel using ${tdate}_results_${base_mo}_${base_yr}_${end_mo}_${end_yr}/`try1a'_24lags_fsp, firstrow(varlabels) replace
save ${tdate}_results_${base_mo}_${base_yr}_${end_mo}_${end_yr}/`try1a'_24lags_results_fsp/`try1a'_24lags_fsp, replace
restore
}
...
collapse (firstnm) state_pc (mean) `try1a'_fra_exp_w `try1a'_fra_exp_w2  `try1a'_tot_pred_w_chg `try1a'_fra_exp_fsp_all* `try1a'_tot_pred_fsp_all_chg  `try1a'_fra_exp_fsp_tc* `try1a'_tot_pred_fsp_tc_chg  `try1a'_fra_exp_fsp_elig `try1a'_fra_exp_fsp_elig2 `try1a'_tot_pred_fsp_elig_chg  `try1a'_fra_exp_fsp_eligb* `try1a'_tot_pred_fsp_eligb_chg `try1a'_fra_exp_fsp_abawd* `try1a'_tot_pred_fsp_abawd_chg `try1a'_fra_exp_fsp_noncit* `try1a'_tot_pred_fsp_noncit_chg $addition_var  `try1a'_fra_exp_wel_o* `try1a'_tot_pred_wel_o_chg  `try1a'_fra_exp_veitc* `try1a'_tot_pred_veitc_chg   `try1a'_fra_exp_es* `try1a'_tot_pred_es_chg `try1a'_fra_exp_o* `try1a'_tot_pred_o_chg `try1a'_total_chg beg_year beg_mo end_year end_mo $unemp12 $welf12 $teitc12 $temp12  dkatrina pop top_states bottom_states top_states_transaction bottom_states_transaction top_states_eligibility bottom_states_eligibility (firstnm) snap_tot yrmo  if yrmo>=`begin_yrmo' & yrmo<=`end_yrmo'   , by(st_fips)
...
foreach set in iebt cert0103_ care cres res tran bio apply ads outre unemp dmeff {
...
collapse (firstnm) state_pc (mean) `try1a'_fra_exp_w `try1a'_fra_exp_w2  `try1a'_tot_pred_w_chg `try1a'_fra_exp_fsp_all* `try1a'_tot_pred_fsp_all_chg  `try1a'_fra_exp_fsp_tc* `try1a'_tot_pred_fsp_tc_chg  `try1a'_fra_exp_fsp_elig `try1a'_fra_exp_fsp_elig2 `try1a'_tot_pred_fsp_elig_chg  `try1a'_fra_exp_fsp_eligb* `try1a'_tot_pred_fsp_eligb_chg `try1a'_fra_exp_fsp_abawd* `try1a'_tot_pred_fsp_abawd_chg `try1a'_fra_exp_fsp_noncit* `try1a'_tot_pred_fsp_noncit_chg $addition_var  `try1a'_fra_exp_wel_o* `try1a'_tot_pred_wel_o_chg  `try1a'_fra_exp_veitc* `try1a'_tot_pred_veitc_chg   `try1a'_fra_exp_es* `try1a'_tot_pred_es_chg `try1a'_fra_exp_o* `try1a'_tot_pred_o_chg `try1a'_total_chg beg_year beg_mo end_year end_mo $unemp12 $welf12 $teitc12 $temp12 dkatrina pop tot_snap_policy tot_snap_policy_eligibility tot_snap_policy_transaction top_states bottom_states top_states_transaction bottom_states_transaction top_states_eligibility bottom_states_eligibility (firstnm) snap_tot yrmo if yrmo>=`begin_yrmo' & yrmo<=`end_yrmo'  , by(st_fips)
...
sort st_fips se
order se
save ${tdate}_results_${base_mo}_${base_yr}_${end_mo}_${end_yr}/`try1a'_12lags_results_fsp/`try1a'_12lags_fsp, replace
export excel using ${tdate}_results_${base_mo}_${base_yr}_${end_mo}_${end_yr}/`try1a'_12lags_fsp, firstrow(varlabels) replace
restore
}
...
*xtscc is fixed effects regression with Driscoll and Kraay (1998) standard errors ;
*Original code used xi command to include dummy variables of st_fips, but since xtscc is fixed effects regression, this is redundant.  I removed the xi code.  Here is original with xi: ;
* xi: xtscc `try1a' d1u d1welfare d1teitc_pay d1iebt d1CertPeriodEarners0103 d1car_1ex d1car_allexempt  d1res d1tranben d1bio d1online d1ads i.st_fips if ( yrmo>=199001), fe
...
collapse (firstnm) state_pc (mean) `try1a'_fra_exp_w `try1a'_fra_exp_w2  `try1a'_tot_pred_w_chg `try1a'_fra_exp_fsp_all* `try1a'_tot_pred_fsp_all_chg  `try1a'_fra_exp_fsp_tc* `try1a'_tot_pred_fsp_tc_chg  `try1a'_fra_exp_fsp_elig `try1a'_fra_exp_fsp_elig2 `try1a'_tot_pred_fsp_elig_chg  `try1a'_fra_exp_fsp_eligb* `try1a'_tot_pred_fsp_eligb_chg  `try1a'_fra_exp_fsp_abawd* `try1a'_tot_pred_fsp_abawd_chg  `try1a'_fra_exp_fsp_noncit* `try1a'_tot_pred_fsp_noncit_chg $addition_var  `try1a'_fra_exp_wel_o* `try1a'_tot_pred_wel_o_chg  `try1a'_fra_exp_veitc* `try1a'_tot_pred_veitc_chg   `try1a'_fra_exp_es* `try1a'_tot_pred_es_chg `try1a'_fra_exp_o* `try1a'_tot_pred_o_chg `try1a'_total_chg beg_year beg_mo end_year end_mo d1u d1welfare d1teitc_pay $temp24  dkatrina pop top_states bottom_states top_states_transaction bottom_states_transaction top_states_eligibility bottom_states_eligibility (firstnm) snap_tot yrmo if yrmo>=`begin_yrmo' & yrmo<=`end_yrmo'  , by(st_fips)
...
sort st_fips se
order se
save ${tdate}_results_${base_mo}_${base_yr}_${end_mo}_${end_yr}/`try1a'_static_results_fsp/`try1a'_static_fsp, replace
export excel using ${tdate}_results_${base_mo}_${base_yr}_${end_mo}_${end_yr}/`try1a'_static_fsp, firstrow(varlabels) replace
restore
}	
